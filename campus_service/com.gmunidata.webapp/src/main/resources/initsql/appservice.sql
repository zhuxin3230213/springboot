...
CREATE TABLE `sc_gmuni_group_people` (
  `id` varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'id',
  `group_code` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '所属组',
  `student_code` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '学生编码',
  `school_code` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '所属学校',
  `create_people` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '创建者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

CREATE TABLE `sc_gmuni_info` (
  `id` varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'id',
  `group_code` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '所属组编码',
  ...
  `type` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '类型(0:默认组 1：创建组)',
  `release_user` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '发布者',
  `faculty` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '性质(0:学院专业，1:班级,2:自定义)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

CREATE TABLE `sc_gmuni_info_group` (
  `id` varchar(100) COLLATE utf8_bin NOT NULL COMMENT 'id',
...
CREATE TABLE `sc_gmuni_driver` (
  `id` varchar(50) COLLATE utf8_bin NOT NULL,
  `code` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '工牌号',
  `name` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '姓名',
  `sex` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '年龄',
  `remarks` varchar(200) COLLATE utf8_bin DEFAULT NULL COMMENT '备注',
  `phone_num` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '手机号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;


CREATE TABLE `sc_gmuni_scheduled_bus` (
  `id` varchar(100) COLLATE utf8_bin NOT NULL,
  `season` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '季节',
  `running_time_type` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '运行时间类型',
  `origin` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '起点',
  `destination` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '终点',
  `riding_point` varchar(200) COLLATE utf8_bin DEFAULT NULL COMMENT '乘车地点',
  `time` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '乘车时间',
  `bus_code` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '车牌号',
  `driver_code` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '司机工号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

CREATE TABLE `sc_gmuni_school_bus` (
  `id` varchar(100) COLLATE utf8_bin NOT NULL,
  `code` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '车牌号',
  `bus_type` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '车型',
  `volume` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '车载容量',
  `bus_series` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '车的系列',
  `parking_space` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '停车位',
  `status` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '状态(0正常,1检修,2年检,3报废)',
  `driving_time` datetime DEFAULT NULL COMMENT '行驶证日期',
  `create_time` datetime DEFAULT NULL COMMENT '添加日期',
  `remarks` varchar(200) COLLATE utf8_bin DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('da63a16480e84b098da0cb76278ca990','xq','校区','-1','33','1',NULL,'1','2018-12-29 09:07:34','1');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('0bdde2e6ca584b828cf2213f185a3956','0','金花校区','da63a16480e84b098da0cb76278ca990','1','1',NULL,'0','2018-12-29 09:08:02','2');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('88d4d15928174b3490a0575685447ed0','1','雁塔校区','da63a16480e84b098da0cb76278ca990','2','1',NULL,'0','2018-12-29 09:08:12','2');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('b87cac20e4994458b03b338d0199c819','busType','班车车型','-1','34','1',NULL,'1','2018-12-29 11:06:00','1');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('75a3709b029d4bd29116e82792d5cea1','db','大巴','b87cac20e4994458b03b338d0199c819','1','1',NULL,'0','2018-12-29 11:06:35','2');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('75ecc8d6d54e4fa296a1a404785826fb','zb','中巴','b87cac20e4994458b03b338d0199c819','2','1',NULL,'0','2018-12-29 11:06:46','2');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('b74e9dbd15e44e378d3b425e205bcbfa','bczt','班车状态','-1','35','1',NULL,'1','2018-12-29 11:11:24','1');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('cc642fd035e04a3086f4613b42f18d62','0','正常','b74e9dbd15e44e378d3b425e205bcbfa','1','1',NULL,'0','2018-12-29 11:11:43','2');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('8ff7ee7625c3467fafb615aca4c8c20c','1','检修','b74e9dbd15e44e378d3b425e205bcbfa','2','1',NULL,'0','2018-12-29 11:11:50','2');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('a613bc3f64f14edb8c9e2957f4ff7fa9','fcsd','校车发车时段','-1','36','1',NULL,'1','2018-12-29 14:48:37','1');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('24bf8451391b494fa41b343107dcc6ac','0','周内','a613bc3f64f14edb8c9e2957f4ff7fa9','1','1',NULL,'0','2018-12-29 14:48:55','2');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('c742754b6b284da2bd17866a56be3c3f','1','周末','a613bc3f64f14edb8c9e2957f4ff7fa9','2','1',NULL,'0','2018-12-29 14:49:03','2');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('347605dc35fa430b96e407fe41a1abff','busSeason','班车季节','-1','37','1',NULL,'1','2018-12-29 14:52:20','1');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('9686697f1ee84690ab0c5659048e3275','0','通用','347605dc35fa430b96e407fe41a1abff','1','1',NULL,'0','2018-12-29 14:52:41','2');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('5ef668ec065d439082b7abf864bf2f02','1','夏季','347605dc35fa430b96e407fe41a1abff','2','1',NULL,'0','2018-12-29 14:52:48','2');
insert into `pf_gmuni_lookup` (`ID`, `code`, `name`, `parent_id`, `sort`, `status`, `remark`, `type`, `create_time`, `level`) values('ab609fef9c2e48dd848db3c9b0dd011c','2','冬季','347605dc35fa430b96e407fe41a1abff','3','1',NULL,'0','2018-12-29 14:53:24','2');

insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('1cb76eca23604cef8f22bc779fd63d42','位置','2','','location','f809cc19b9994a54996313b1da1d1609','studentInfoLocationBtn',NULL,'2018-12-03 10:41:48','1','6');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('589aa015debd4e768dd58e0751e4d6f5','校车管理','0','','','5c272d01bf0a45d8b6fe61107e81ad83','xcgl',NULL,'2018-12-28 15:22:15','1','9');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('90bfaeaf845e4a228014325a260c8f87','车辆管理','1','/smartschool/busManagement','','589aa015debd4e768dd58e0751e4d6f5','clgl',NULL,'2018-12-28 15:23:09','1','2');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('5c105b978fb6459e8ac8b527464455f4','通勤班车管理','1','/smartschool/busPlan','','589aa015debd4e768dd58e0751e4d6f5','tqbcgl',NULL,'2018-12-28 15:23:39','1','3');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('4425143c437b4110a116e93dddd1ffa4','司机管理','1','/smartschool/busDriver','','589aa015debd4e768dd58e0751e4d6f5','sjgl',NULL,'2018-12-28 16:21:20','1','1');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('2890870cbb314754be37b828aa23688b','新增','2','','add','4425143c437b4110a116e93dddd1ffa4','busDriverAddBtn',NULL,'2018-12-28 16:25:37','1','1');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('ec276281cea74142933932f2bf84275a','编辑','2','','edit','4425143c437b4110a116e93dddd1ffa4','busDriverEditBtn',NULL,'2018-12-28 16:26:08','1','2');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('c431f7d5bc5f4bf5a21ac8b8913f6aba','删除','2','','remove','4425143c437b4110a116e93dddd1ffa4','busDriverRemoveBtn',NULL,'2018-12-28 16:26:41','1','3');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('d2f2162c1ce841cf979d4c6a1ccd03e6','新增','2','','add','90bfaeaf845e4a228014325a260c8f87','busManageAddBtn',NULL,'2018-12-28 16:27:37','1','1');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('882fe4b41aca4ec1a7e5c1bfcc77066f','编辑','2','','edit','90bfaeaf845e4a228014325a260c8f87','busManageEditBtn',NULL,'2018-12-28 16:28:15','1','2');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('55c09ced1dfc4f41b1d24592897873c6','删除','2','','remove','90bfaeaf845e4a228014325a260c8f87','busManageRemoveBtn',NULL,'2018-12-28 16:28:39','1','3');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('f1113eaf4839444882e588d1599c9ce0','新增','2','','add','5c105b978fb6459e8ac8b527464455f4','busPlanAddBtn',NULL,'2018-12-28 16:28:59','1','1');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('ffec41133d854aeaa020d7c174bb3044','编辑','2','','edit','5c105b978fb6459e8ac8b527464455f4','busPlanEditBtn',NULL,'2018-12-28 16:38:13','1','2');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('9406becb070d47f89753b5dde0325741','删除','2','','remove','5c105b978fb6459e8ac8b527464455f4','busPlanRemoveBtn',NULL,'2018-12-28 16:29:40','1','3');
insert into `pf_gmuni_resource` (`id`, `name`, `type`, `url`, `button_code`, `parent_id`, `code`, `parent_code`, `create_time`, `status`, `sort`) values('74fd8b1058c64f24a2bcfbfb4e2046c1','导出','2','','exportBtn','5c105b978fb6459e8ac8b527464455f4','busPlanExportBtn',NULL,'2018-12-28 16:37:51','1','4');
